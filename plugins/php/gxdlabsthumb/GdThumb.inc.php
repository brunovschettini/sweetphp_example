...
class GdThumb extends ThumbBase
{
	...
	public function show ($rawData = false) 
	{
		if (headers_sent())
		{
			throw new RuntimeException('Não é possível mostrar imagem, cabeçalhos já foram enviados');
		}
	...
	public function save ($fileName, $format = null)
	{
		...
		{
			throw new InvalidArgumentException ('Tipo de formato inválido especificado em função de economia: ' . $format);
		}
