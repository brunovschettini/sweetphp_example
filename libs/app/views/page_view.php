        ...
        <div class="row" style="margin-top: 15px; border-top: 1px solid red">
            <div class="columns large-12">
                ...
                <form class="sweetForm" name="Welcome">
                    ...
                    <input type="submit" name="action" data-action="contact" value="Contato" data-return=".returnAjax" data-update="idCliqueAqui"/>
                    <input type="submit" name="action" data-action="backIndex" value="Inicio" />
                </form>
                <span class="returnAjax" style="color: red;">Seu retorno do ajax aqui!</span>
                <br />
                <br />
                <input type="submit" name="action" value="Clique aqui!!!" onclick="alert('Testado')" id="idCliqueAqui"/>
                <br />
                <br />
