 ...
 * 
 * Mecanismos de Template permitem manter o cÛdigo HTML em arquivos externos
 * que ficam completamente livres de c√≥digo PHP. Dessa forma, consegue-se manter 
 * a lÛgica de programacao (PHP) separada da estrutura visual (HTML ou XML, CSS, etc).
 *
 * Se vocÈ nao È familiar ao uso de mecanismos de template PHP, esta classe inclui 
 ...
 * avisando quando tentamos chamar blocos ou variaveis que nao existem, avisando quando 
...
class Template {
	 ...
	 * 
	 * Quando o parametro $accurate È true, a substituicao dos blocos no arquivo   
	 * final sera perfeitamente fiel ao arquivo original, isto È, todas as tabulacıes 
	 * serao removidas. Isso vai ter um pequeno prejuÌzo na performance, que pode variar 
	 * de acordo com a versao do PHP em uso. Mas È ˙til quando estamos usando tags HTML 
	 * como &lt;pre&gt; ou &lt;code&gt;. Em outros casos, ou melhor, quase sempre, 
	 * nunca se mexe no valor de $accurate.
	 *
	 * @param     string $filename		caminho do arquivo que sera lido
	 * @param     booelan $accurate		true para fazer substituicao fiel das tabulacıes 
	 */
	...
	/**
	 * Adiciona o conteudo do arquivo identificado por $filename na variavel de template 
	...
	/**
	 * N√£o use este mÈtodo, ele serve apenas para podemos acessar as variaveis
	...
	/**
	 * Nao use este mÈtodo, ele serve apenas para podemos acessar as variaveis 
	 * de template diretamente.
	 *
	 * @param	string	$varname	template var name
	 */
	...
	/**
	 * Verifica se uma variavel de template existe.
	 *
	 * Retorna true se a variavel existe. Caso contrario, retorna false.
	 *
	 * @param	string	$varname	template var name
	 */
	 ...
	 * Mostra um bloco.
	 * 
	 * Esse metodo deve ser chamado quando um bloco deve ser mostrado.
	 * Sem isso, o bloco nao ira° aparecer no conteudo final.
	 *
	 * Se o parametro $append for true, o conteudo do bloco sera° 
	 * adicionado ao conteudo que ja existia antes. Ou seja, use true 
	 * quando quiser que o bloco seja duplicado.
	 *
	 * @param     string $block		nome do bloco que deve ser mostrado
	 * @param     boolean $append		true se o conteudo anterior deve ser mantido (ou seja, para duplicar o bloco)
	 */
	...
	/**
	* Retorna o conteudo final, sem mostra-lo na tela. 
	* Se vocÍ quer mostra-lo na tela, use o metodo Template::show().
	* 
	* @return    string	
	*/
	...
	/**
	 * Mostra na tela o conteudo final.
	 */
